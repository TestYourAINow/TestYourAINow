        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <div className="bg-gray-900/50 rounded-lg p-4 border border-gray-600">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-medium">{connectionName}</p>
          ...
          <div className="bg-red-900/20 border border-red-800/30 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-red-300 space-y-1">
              ...
              <li>• The widget will be immediately disabled on all websites</li>
              <li>• All data for this connection will be permanently lost</li>
            </ul>
          </div>
