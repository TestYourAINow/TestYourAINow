        ...
        <div className="overflow-y-auto max-h-[85vh] md:max-h-[70vh] custom-scrollbar">
          ...
          <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-700/50">
            <div className="flex items-center gap-4">
              <div className="relative w-12 h-12 rounded-xl overflow-hidden ring-2 ring-white/40">
                <Image
                  src="/icons/file-upload-icon.png"
          ...
          <div className="p-4 md:p-6 space-y-4 md:space-y-6">
            ...
            <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-4 backdrop-blur-sm">
              ...
              <div
                {...getRootProps()}
                className={`border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 backdrop-blur-sm relative overflow-hidden group ${isDragging
              ...
              >
                ...
                <div className="flex flex-col items-center gap-4 relative z-10">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-300 ${isDragging
                    ...
                    <Upload className={`w-8 h-8 transition-colors duration-300 ${isDragging ? "text-blue-400" : "text-gray-400 group-hover:text-gray-300"
                      }`} />
                  </div>
                  <div>
