  ...
  const integrationOptions = [
    {
      ...
      iconPath: "/icons/file-upload-icon.png",
    ...
    },
    {
      ...
      iconPath: "/icons/webhook-icon.png",
    ...
    },
    {
      ...
      iconPath: "/icons/calendly-icon.png",
            ...
            {integrationOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-5 rounded-xl border transition-all duration-300 text-left group relative overflow-hidden ${option.disabled
                ...
                >
                  ...
                  <div className="flex items-start gap-4 relative z-10">
                    <div className="relative w-14 h-14 rounded-xl overflow-hidden group-hover:scale-110 transition-all duration-300 shadow-lg ring-2 ring-white/30">
                      <Image
                        src={option.iconPath}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        <h3 className={`text-lg font-bold ${option.disabled ? 'text-gray-400' : 'text-white bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent'
                          }`}>
                          {option.title}
                        </h3>
                      </div>
                      <p className={`text-sm leading-relaxed ${option.disabled ? 'text-gray-500' : 'text-gray-300'
                        }`}>
