...
export async function GET(
  ...
  try {
    ...
    // 🎯 HTML VANILLA JS - IDENTIQUE AU DASHBOARD
    const html = `
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <script>
    ...
    // 🎯 CLASSE WIDGET VANILLA - REPRODUCTION EXACTE DU DASHBOARD
    class ProductionChatWidget {
      constructor(config) {
        this.config = config;
        this.messages = [];
        this.isOpen = false;
      ...
      createWidget() {
        ...
        root.innerHTML = \`
          <div class="chat-widget" style="--primary-color: \${this.config.primaryColor}; position: fixed; bottom: 24px; right: 24px; z-index: 9999;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
      window.chatWidget = new ProductionChatWidget(window.WIDGET_CONFIG);
    });
