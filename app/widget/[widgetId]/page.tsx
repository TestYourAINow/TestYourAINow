...
// 🎯 PAGE WIDGET SIMPLE SANS REACT HYDRATION
export default async function WidgetStandalonePage({ 
  ...
  try {
    ...
    // 🎨 CSS COMPLET INLINE (basé sur ton ChatWidget.module.css)
    const widgetCSS = `
          ...
          __html: `
              ...
              <div class="chat-window hidden" id="chatWindow">
                ...
                <div class="chat-header">
                  ...
                  <div class="chat-actions">
                    <button class="chat-action-btn" id="resetBtn">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="1 4 1 10 7 10"></polyline>
                        <path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"></path>
                      </svg>
                    </button>
                    <button class="chat-action-btn" id="closeBtn">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  ...
                  <div id="messagesContainer">
                    ${config.showWelcomeMessage && config.welcomeMessage ? `
                      <div class="message bot">
                        <img src="${config.avatar || '/Default Avatar.png'}" alt="Bot" class="message-avatar">
                        <div>
            ...
            <script>
              ...
              async function sendMessage() {
                ...
                try {
                  const response = await fetch('/api/agents/' + config.selectedAgent + '/ask', {
                    ...
                    body: JSON.stringify({
                      message: text,
                      previousMessages: messages.map(m => ({ role: m.isBot ? 'assistant' : 'user', content: m.text })),
              ...
              function addMessage(text, isBot) {
                ...
                messageEl.innerHTML = isBot ? 
                  '<img src="' + (config.avatar || '/Default Avatar.png') + '" alt="Bot" class="message-avatar"><div><div class="message-bubble bot">' + text + '</div><div class="message-timestamp">' + new Date().toLocaleTimeString([], {hour: '2-digit', minute: '2-digit'}) + '</div></div>' :
                  '<div><div class="message-bubble user">' + text + '</div><div class="message-timestamp">' + new Date().toLocaleTimeString([], {hour: '2-digit', minute: '2-digit'}) + '</div></div>';
              ...
              function showTyping() {
                ...
                typingEl.innerHTML = '<img src="' + (config.avatar || '/Default Avatar.png') + '" alt="Bot" class="message-avatar"><div><div class="typing-indicator"><div class="typing-dot"></div><div class="typing-dot"></div><div class="typing-dot"></div></div></div>';
              ...
              parent.postMessage({ type: 'WIDGET_READY', data: { width: config.width, height: config.height } }, '*');
            </script>
          `
        }} />
      </html>
